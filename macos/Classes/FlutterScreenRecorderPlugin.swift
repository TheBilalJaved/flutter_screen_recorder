...
public class FlutterScreenRecorderPlugin: NSObject, FlutterPlugin {
    private let recorder = RPScreenRecorder.shared()
    private var audioEngine: AVAudioEngine?

    public static func register(with registrar: FlutterPluginRegistrar) {
        let channel = FlutterMethodChannel(name: "flutter_screen_recorder", binaryMessenger: registrar.messenger)
